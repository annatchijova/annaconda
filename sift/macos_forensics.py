...
from core.ebs_v1 import SignalOutput, Z_CLIP_MAX
from core.chain_of_custody import ChainOfCustody
from sift._fs_utils import scan_marker_names
from sift._math_utils import build_correlation_groups, noisy_or_correlated
from sift._sql_utils import safe_sqlite_connect
...
class MacOSForensicsAnalyzer:
    ...
    def _analyze_fsevents(
        ...
        """
        from sift.fsevents_parser import parse_fseventsd_dir
