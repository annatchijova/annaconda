...
from security.output_boundary import validate_external_output_path
...
_pipeline_mod, _pipeline_name = _try_imports(
    ["pipeline.pipeline", "pipeline__4_"], ["run_vigia", "VigiaPipeline"]
)
...
_caie_mod, _caie_name = _try_imports(["tools.caie", "vigia.tools.caie", "caie"], ["CrossArtifactIncongruenceEngine"])
...
class ReportAdapter:
    ...
    def sealed_to_case_result(
        ...
        from core.enfsi import enfsi_label as _enfsi_canonical
    ...
    def run_case(
        ...
        if ecl_hash:
            ...
            try:
                ...
                try:
                    from core.bundle_builder import BundleBuilder  # type: ignore
                except ImportError:
