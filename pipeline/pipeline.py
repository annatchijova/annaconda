...
from core.likelihood_engine import LikelihoodEngine
from core.graph_stability import GraphStabilityEngine
from core.risk_bounded_layer import (
    RiskBoundedDecisionLayer, SelfAdaptiveRiskPolicy, PolicyStabilityController,
)
from core.audit_action import (
    EvidenceGraphDiff, InterventionOptimizer,
    FormalPolicyEngine, SafeActionExecutor,
)
from core.bundle_builder import BundleBuilder
...
try:
    from core.lr_calibration import LRCalibrator
...
try:
    from core.execution_logger import VigiaExecutionLogger
...
class VigiaPipeline:
    ...
    def _signal_anchor_graph(signals: List[SignalOutput]) -> EvidenceGraph:
        ...
        """
        from core.bundle_builder import _sha256_dict
        labels: List[str] = []
        for s in signals:
    ...
    def run_full(
        ...
        try:
            ...
            from core.risk_bounded_layer import RiskBoundedDecisionLayer as _RBL
        ...
        try:
            ...
            from tools.caie import cross_artifact_analysis
        ...
        if hasattr(self, '_last_caie_result') and self._last_caie_result:
            ...
            if caie_analysis.get("verdict") in ("MALICE", "INTENT"):
                from core.devil_advocate_gen import compose_devil_advocate_struct
