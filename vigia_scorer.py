...
# ---------------------------------------------------------------------------
try:
    from verdict.quadripartite import QuadripartiteClassifier as _QuadClassifier
...
def _vigia_score(case: dict) -> dict:
    ...
    _ECO_AVAILABLE = True
    try:
        from core.eco_check import text_obvious_bait_hits as _eco_bait_hits
    except Exception:
    ...
    for a in artifacts:
        ...
        try:
            from tools.caie import EVIDENCE_PROFILES, Artifact as _CaieArtifact
    ...
    if hard_temporal:
        ...
        try:
            from tools.caie import EVIDENCE_PROFILES as _EPROF
            def _spoof(_t):
                _p = _EPROF.get(_t)
    ...
    # -----------------------------------------------------------------------
    try:
        from core.signal_quality_shadow import shadow_signal_quality
    ...
    # -----------------------------------------------------------------------
    try:
        from core.darvo_detector import detect_darvo_pattern
