...
# R3-2: consumidor fuera del camino de bundle sellado — output JSON de resultados del pipeline (no bundle sellado).
...
from core.canonicalize import _canonicalize_v1 as _canonicalize  # noqa: F401
from core.atomic_io import atomic_write_text
from security.output_boundary import validate_external_output_path

try:
    from core.semiotic_detector_v2 import SemioticDetectorV2
